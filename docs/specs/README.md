...
- the inputs and outputs it accepts
- the behavior and constraints that tests and code currently enforce
- known gaps and deferred complexity so roadmap items do not masquerade as shipped behavior
